...
/* #THORIN: new params assoc.w. energy eq. implementation */
  ...
  var("OPACITYDROP", &OPACITYDROP, REAL, NO, "1.0");
  ...
  var("OPACITYLAW", OPACITYLAW, STRING, NO, "BELL");
...
/* #THORIN: setup of the boundary conditions */
  ...
  var("DISKACCRETION", &DISKACCRETION, REAL, NO, "0.0");
...
/* #THORIN: new params assoc.w. pebble accretion */
  ...
  var("FRAGMENTVELOC", &FRAGMENTVELOC, REAL, NO, "1000.0");
/* #THORIN: tools */
